...
Code in this folder carries no comments (owner preference, 2026-08-16) — the reasoning
behind each definition lives in the session notes in `.claude/PROGRESS.md`.
